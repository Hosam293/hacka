          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children:
                [
                  Icon(Icons.leaderboard_outlined,color: orange,size: subText,),
                  const SizedBox(
                    width: 20,
                  ),
                  TextWidget(
              ...
              Row(
                ...
                children:
                [
                  Icon(Icons.location_on_outlined,color: orange,size: subText,),
                  const SizedBox(
                    width: 20,
                  ),
                  TextWidget(
              ...
              Container(
                  ...
                  child: TextWidget(
                      ...
                      fontsize: subText)),
Expanded(
  child:   ListView.separated(itemBuilder: (BuildContext context, int index) =>Row(
